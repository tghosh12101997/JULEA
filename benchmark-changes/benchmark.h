...
// Structure to handle benchmark runs, including an array for individual timings.
struct BenchmarkRun
{
    gchar* name;
    void (*func)(struct BenchmarkRun*, GArray*);
    GTimer* timer;
    gboolean timer_started;
    guint iterations;
    guint64 operations;
    guint64 bytes;
    GArray* timings;  // Array to store timings for individual operations.
};

typedef struct BenchmarkRun BenchmarkRun;
typedef void (*BenchmarkFunc)(BenchmarkRun*, GArray*);
