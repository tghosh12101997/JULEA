...
{
    guint const n = 1000; // This can be modified to control the number of files processed
    ...
    while (j_benchmark_iterate(run))
    {
        ...
        for (guint i = 0; i < n; i++)
        {
            GTimer* op_timer = g_timer_new(); // Start operation timer
            g_autoptr(JItem) item = NULL;
            g_autofree gchar* name = g_strdup_printf("benchmark-%d", i);
...
benchmark_item(void)
{
    j_benchmark_add("/item/create", benchmark_item_create);
    j_benchmark_add("/item/create-batch", benchmark_item_create_batch);
    j_benchmark_add("/item/delete", benchmark_item_delete);
    j_benchmark_add("/item/delete-batch", benchmark_item_delete_batch);
    j_benchmark_add("/item/delete-batch-without-get", benchmark_item_delete_batch_without_get);
    j_benchmark_add("/item/get-status", benchmark_item_get_status);
    j_benchmark_add("/item/get-status-batch", benchmark_item_get_status_batch);
    j_benchmark_add("/item/read", benchmark_item_read);
    j_benchmark_add("/item/read-batch", benchmark_item_read_batch);
    j_benchmark_add("/item/write", benchmark_item_write);
    j_benchmark_add("/item/write-batch", benchmark_item_write_batch);
    j_benchmark_add("/item/unordered-create-delete", benchmark_item_unordered_create_delete);
    j_benchmark_add("/item/unordered-create-delete-batch", benchmark_item_unordered_create_delete_batch);
}