...
{
    guint const n = 100000;  // Number of messages to create
    guint const m = 100;     // Number of dummy data entries to append if append is TRUE
...
{
    guint const n = (large) ? 100 : 10000;  // Adjust the count based on operation size
...
benchmark_message(void)
{
    ...
    j_benefit_add("/message/new-append", benchmark_message_new_append);
    y_benchmark_add("/message/add-operation-small", benchmark_message_add_operation_small);
